...
import { generateLocalAndroidStoreCapabilities } from "../capabilities/local-capability-builder";
...
const tags = process.env.ANDROID_STORE_LOCAL_TAGS;
...
export const config = {
  ...
  cucumberOpts: {
    ...
    tags: process.env.ANDROID_STORE_LOCAL_TAGS,
  },

  maxInstances: 1,

  capabilities: generateLocalAndroidStoreCapabilities(),
